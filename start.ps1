...
$env:THUMB_CLIENT_MAX_CONCURRENCY="14"   # 썸네일 매니저 동시 요청 (로컬 벤치 high profile)
$env:GRID_MAX_CONCURRENCY="48"           # 그리드 썸네일 동시 요청 상한 (cold 48-burst 기준 최적)
$env:MEASURE_PREFETCH_CONCURRENCY="8"    # measure-thumb-batch 동시 워밍업 상한
$env:THUMBNAIL_EXECUTOR_WORKERS="32"     # 16C 로컬 개발기 기준 2x core
