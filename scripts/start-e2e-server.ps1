...
$env:AUTO_LOGIN = if ([string]::IsNullOrWhiteSpace($env:E2E_AUTO_LOGIN)) { "0" } else { $env:E2E_AUTO_LOGIN }
$env:HOST = "0.0.0.0"
$env:PORT = "5354"
$env:RELOAD = "0"
...
$env:IMAGES_ROOT = "E:/data/images"
$env:POSITIONS_ROOT = "E:/data/positions"
$env:LAYOUT_ROOT = "E:/data/layout"
$env:LAYOUT_FILE = "E:/data/layout/layout.parquet"
